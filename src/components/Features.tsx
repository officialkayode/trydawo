    ...
    <section className="section bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h3 className="text-xl md:text-2xl font-bold mb-6">Back the Founders You Believe In. Grow Together.</h3>
          <p className="text-lg text-gray-600">
          Invest directly in founders you know and trust. Whether it's your friend building the next big thing, or that local startup you've watched grow from day one - now you can be part of their journey and success.
          </p>
        </div>
